    ...
    <>
      ...
      <section className="hero-subpage" id="pipeline-hero">
        ...
        <p className="hero-deck">
          Every article published on Nimigora passes through a four-stage
        ...
        <div style={{ marginBottom: '48px' }}>
          <div className="category-card" style={{ cursor: 'default' }}>
            ...
            <p className="category-desc" style={{ maxWidth: '800px', fontSize: '16px', lineHeight: '1.7' }}>
              Our pipeline monitors 50+ global RSS feeds across six categories:
              technology, geopolitics, climate, finance, health, and culture.
              We pull from trusted publications and use AI-powered story selection
              to identify the most impactful, engaging, and culturally significant stories.
